...
struct Options { var candidateLimit = 50, chunkLimit = 20, noteLimit = 10
                 var rrfK = 20.0        // ADR-041 lowered this from 60
...
corpus, and the reasoning is worth carrying into any future change (ADR-041):
...
the whole picture changes (ADR-042, `docs/verification/M3-perf.md`):
