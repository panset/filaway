...
## ADR-041 — Retrieval constants are measured on a corpus, not derived from first principles
...
## ADR-042 — The dev corpus is generated from curated tables, and scale numbers are measured on it
