...
## ADR-058 — Typo repair reads FTS5's own term index, through a migration
...
## ADR-059 — The indexer owns its own QoS and its own ordering
...
## ADR-060 — The retrieval log lives outside the library, and holds queries
